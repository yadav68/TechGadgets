const API_BASE_URL =
  process.env.NODE_ENV === "production" ? "" : "http://localhost:5002/api";
...
export const cartAPI = {
  ...
  addToCart: (productId) =>
    apiCall(`/cart/add/${productId}`, {
      method: "POST",
    }),

  updateQuantity: (productId, quantity) =>
    apiCall(`/cart/update/${productId}`, {
      method: "PUT",
...
export const adminAPI = {
  ...
  toggleUserAdmin: (userId) =>
    apiCall(`/admin/users/${userId}/toggle-admin`, {
      method: "PUT",
    }),
...
export const categoryAPI = {
  ...
  getWithProductCount: () =>
    apiCall("/categories/with-product-count", { method: "GET" }),
