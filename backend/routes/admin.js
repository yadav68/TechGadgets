...
router.get("/newsletters", isAdmin, getNewsletterSubscribers);
router.delete("/newsletters/:id", isAdmin, removeNewsletterSubscriber);
router.get("/newsletters/export", isAdmin, exportNewsletterSubscribers);
